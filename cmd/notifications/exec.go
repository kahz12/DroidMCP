...
const (
	...
	binNotify       = "termux-notification"
	binNotifyList   = "termux-notification-list"
	binNotifyRemove = "termux-notification-remove"
...
// into capped buffers and applying the per-call timeout.
func runCmd(ctx context.Context, name string, args []string, timeout time.Duration) (*cmdResult, error) {
	if timeout <= 0 {
